...
- MPRO: 130° QUERETARO (sucursal 0021), ORIGEN (sucursal 0023)
...
# =============================================================================
# CONFIGURACIÓN DE UNIDADES (MISMAS 5 UNIDADES)
# =============================================================================

# Unidades SoftRestaurant
UNIDADES_SOFTRESTAURANT = [
    {
...
# Unidades MPRO (comparten server_id, difieren en sucursal_id)
UNIDADES_MPRO = [
    {
