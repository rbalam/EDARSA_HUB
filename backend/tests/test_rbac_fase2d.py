...
Test Users:
- ADMIN: Uses test_config credentials (role=Administrador)
- OPERADOR: Uses test_config credentials (role=Usuario)
...
# Operador credentials (for RBAC testing - less privileged user)
OPERADOR_EMAIL = os.getenv('TEST_OPERADOR_EMAIL', 'operador.test@edarsa.com')
OPERADOR_PASSWORD = os.getenv('TEST_OPERADOR_PASSWORD', 'OperadorTest2024!')
...
class TestCargosRBAC:
    ...
    def test_post_cargos_admin(self, admin_token):
        ...
        assert response.status_code != 403, "Admin should have CARGOS_CREAR permission"
...
class TestResponsabilidadRBAC:
    ...
    def test_post_disputar_operador_allowed(self, operador_token):
        ...
        assert response.status_code != 403, "Operador should have RESPONSABILIDAD_DISPUTAR permission, got 403"
...
class TestSLARBAC:
    ...
    def test_put_sla_config_admin(self, admin_token):
        ...
        assert response.status_code != 403, "Admin should have SLA_CONFIGURAR permission"
