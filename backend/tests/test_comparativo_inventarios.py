...
if not BASE_URL:
    BASE_URL = "https://stock-tracker-990.preview.emergentagent.com"
...
class TestComparativoInventarios:
    ...
    def test_07_export_without_almacen_fails(self):
        ...
        print(f"✅ Validation works - empty almacenes rejected")
...
class TestSQLQueryDateComparison:
    ...
    def test_11_date_comparison_in_export(self):
        ...
        if response.status_code == 200:
            print(f"✅ Date comparison working - found cortes for fecha_referencia=2026-04-07")
        elif response.status_code == 404:
...
class TestFrontendDataStructure:
    ...
    def test_12_inventarios_finales_info_structure(self):
        ...
        if response.status_code == 200:
            print(f"✅ Backend accepts inventarios_finales_info with almacen_id and fecha")
        else:
