...
class TestServerCooldown:
    ...
    def test_mark_server_offline(self):
        ...
        assert is_server_offline_in_memory("test-server-1") is True
    ...
    def test_mark_server_online(self):
        ...
        assert is_server_offline_in_memory("test-server-2") is False
    ...
    def test_server_not_in_cache(self):
        ...
        assert is_server_offline_in_memory("server-no-existe") is False
