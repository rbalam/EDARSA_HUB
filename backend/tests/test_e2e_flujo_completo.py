...
class E2EValidator:
    ...
    def cleanup_test_data(self):
        ...
        test_id = self.test_data.get("test_id", "")
        
        # Limpiar colecciones de prueba
        collections = [
            ("users", {"id": {"$regex": f"USR-E2E"}}),
    ...
    def paso_2_workflow_cierra(self) -> bool:
        ...
        from modules.fase2_operativo.schemas.enums import EstadoWorkflow
        ...
        print_info(f"Transiciones válidas definidas en WorkflowService:")
    ...
    def paso_3_cierre_genera_responsabilidad(self) -> bool:
        ...
        try:
            ...
            print_ok(f"Responsabilidad calculada:")
    ...
    def paso_5_cargo_dispara_notificaciones(self) -> bool:
        ...
        print_info(f"Métodos de notificación disponibles:")
        for m in metodos:
            print_info(f"  - {m}")
