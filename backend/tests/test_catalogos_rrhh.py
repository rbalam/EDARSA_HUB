...
SUPERVISOR_EMAIL = os.environ.get("TEST_SUPERVISOR_EMAIL", TEST_SUPERVISOR_EMAIL)
SUPERVISOR_PASSWORD = os.environ.get("TEST_SUPERVISOR_PASSWORD", TEST_SUPERVISOR_PASSWORD)
