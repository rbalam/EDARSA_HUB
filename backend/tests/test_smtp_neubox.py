...
async def test_send_email(destinatario: str):
    ...
    if resultado.get('success'):
        print_ok(f"Email enviado exitosamente")
...
async def main():
    ...
    if not provider.is_available():
        ...
        print(f"  EMAIL_HOST=mail.tudominio.com")
        print(f"  EMAIL_PORT=587")
        print(f"  EMAIL_USER=notificaciones@tudominio.com")
        print(f"  EMAIL_PASSWORD=tu_password_aqui")
