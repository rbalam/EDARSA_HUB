...
| B5175237... | HR2020 ESCRITURA | MANAGEMENTPRO | <REDACTED_EDARSAHUB_SQL_HOST> | ENCRYPTED | SUCCESS |
| A5FF0E25... | LA ESTELAR | SOFTRESTAURANT | serverestelar.ddns.net | ENCRYPTED | SOURCE_UNREACHABLE |
| 1B230A06... | ManagmentPro | MANAGEMENTPRO | <REDACTED_EDARSAHUB_SQL_HOST> | ENCRYPTED | SUCCESS |
| D1D8C70F... | MPRO TABLAJERIA | MANAGEMENTPRO | <REDACTED_EDARSAHUB_SQL_HOST> | ENCRYPTED | SUCCESS |
| D8425038... | PRUEBAS SOFTRESTAURANT | SOFTRESTAURANT | <REDACTED_EDARSAHUB_SQL_HOST>\SOFTREST | ENCRYPTED | SUCCESS |
