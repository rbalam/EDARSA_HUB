...
- Fecha: 2026-06-02T16:32:24.846930
- Modo: `migrate`
...
## Detalle
```text
Error ejecutando SQL. Se hizo rollback. Detalle: (544, b"Cannot insert explicit value for identity column in table 'Usuario_PermisosRolModulo' when IDENTITY_INSERT is set to OFF.DB-Lib error message 20018, severity 16:\nGeneral SQL Server error: Check messages from the SQL Server\n")
```
...
-- Limpieza de tabla temporal se hace automáticamente al cerrar sesión
