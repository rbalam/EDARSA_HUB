...
- Fecha: 2026-06-02T09:51:23.380011
- Modo: `migrate`
...
-- 5. ÍNDICES (en batch separado para evitar errores)
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Comercial_Intel_VentasDetalle_Fecha')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Comercial_Intel_VentasDetalle_Unidad')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Comercial_Intel_VentasDetalle_Producto')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'UX_Comercial_Intel_VentasDetalle_NoDup')
BEGIN
