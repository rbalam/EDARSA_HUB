...
/* RESULTSET 2: Catálogo exacto de objetos RBAC, usuarios y menús */
SELECT
...
/* RESULTSET 3: Columnas reales de las tablas candidatas */
SELECT
    s.name AS schema_name,
...
/* RESULTSET 4: Claves primarias y restricciones únicas */
SELECT
    s.name AS schema_name,
    t.name AS table_name,
...
/* RESULTSET 5: Foreign keys reales */
SELECT
...
/* RESULTSET 6: Índices, incluidos los únicos y filtrados */
SELECT
    s.name AS schema_name,
    t.name AS table_name,
...
/* RESULTSET 7: Triggers que pueden introducir escrituras indirectas */
SELECT
    s.name AS schema_name,
    t.name AS table_name,
...
/* RESULTSET 8: Dependencias SQL declaradas entre objetos */
SELECT DISTINCT
...
/* RESULTSET 9: Tamaño lógico, sin leer datos de negocio */
SELECT
    s.name AS schema_name,
    t.name AS table_name,
