...
BEGIN TRY
    ...
    VALUES
        ('DIRECCION', 'COMPRAS_FACT', 'GESTIONAR'),
        ('GERENTE_OPS', 'COMPRAS_FACT', 'GESTIONAR');
    ...
    SELECT
        ...
        1,
        GETDATE(),
        'RBAC_COMPRAS_GESTIONAR_OPERATIVO_EXPLICIT'
    FROM @Objetivos o
    ...
    JOIN dbo.Usuario_Modulos m ON m.ModuloID = prm.ModuloID
    JOIN dbo.Usuario_Acciones a ON a.AccionID = prm.AccionID
    WHERE r.CodigoRol IN ('DIRECCION', 'GERENTE_OPS', 'SUPERADMIN')
