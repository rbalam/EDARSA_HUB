-- EDARSAHUB V1.0
-- Migracion: corregir ticket_promedio del overlay runtime
-- Regla: ticket_promedio/pax_promedio = venta visible sin propina / pax
-- Nota: este script no se ejecuta automaticamente; requiere autorizacion explicita.
-- Fecha: 2026-07-08
