...
Activar permisos SQL explícitos sensibles Fase 2 para SUPERADMIN.
...
- No asigna permisos sensibles a ADMIN.
- No crea usuarios.
- No toca MongoDB.
...
BEGIN TRY
    ...
    IF EXISTS (
        ...
        THROW 51000, 'Falta uno o más módulos activos requeridos.', 1;
    ...
    IF EXISTS (
        ...
        THROW 51000, 'Falta una o más acciones activas requeridas.', 1;
    ...
    SELECT
        ...
        1,
        SYSDATETIME(),
        'RBAC_PHASE2F_SUPERADMIN_SENSITIVE_PERMS'
    ...
    SELECT
        'RBAC_SUPERADMIN_SENSITIVE_PHASE2_PERMISSIONS_MIGRATION' AS paso,
        @PermisosInsertados AS permisos_insertados,
        @PermisosReactivados AS permisos_reactivados;

    SELECT
        'RBAC_SUPERADMIN_SENSITIVE_PHASE2_PERMISSIONS_RESULT' AS paso,
        r.CodigoRol,
        m.CodigoModulo,
        a.CodigoAccion,
