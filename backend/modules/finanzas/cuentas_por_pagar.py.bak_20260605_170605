...
async def listar_facturas_pendientes(
    ...
    if use_demo:
        ...
        es_filtro_mpro_exclusivo = sucursal_id and any(
            ...
            for alias in ['ORIGEN', '130QRO', '130 QRO', '130° QRO', '130° QUERETARO', '0021', '0023']
        )
        ...
        softrest_sucursales = ['CIENFUEGOS', 'ESTELAR', '130MID', 'CF', 'EST', '130M', 'LA ESTELAR', '130 MERIDA', '130° MERIDA', 'CIEN FUEGOS']
        mpro_sucursales = ['ORIGEN', '130QRO', '130 QRO', '130° QRO', '130° QUERETARO', '0021', '0023']
        ...
        if mpro_repo and not es_filtro_softrest:
            try:
                ...
                mpro_sucursal = None
                if es_filtro_mpro:
                    if sucursal_id and ('ORIGEN' in sucursal_id.upper() or sucursal_id == '0023'):
                        mpro_sucursal = '0023'
...
async def get_resumen_cuentas_por_pagar(
    ...
    if use_demo:
        ...
        softrest_sucursales = ['CIENFUEGOS', 'ESTELAR', '130MID', 'CF', 'EST', '130M', 
                               'LA ESTELAR', '130 MERIDA', '130° MERIDA', 'CIEN FUEGOS']
        mpro_sucursales = ['ORIGEN', '130QRO', '130 QRO', '130° QRO', '130° QUERETARO', 
                          '0021', '0023']
