...
# =============================================================================
# OPERACIONES EN vw_Comercial_KPIs_Diarios_v2_Runtime
# =============================================================================
    ...
    if existing:
        ...
        if record.get('hash_origen') == kpi.hash_origen and str(record.get('fuente_original') or '') == str(kpi.fuente_original):
            ...
            UPDATE dbo.Comercial_KPIs_Diarios_v2 SET
                ...
                pax_promedio = {kpi.ticket_promedio},
        ...
        INSERT INTO dbo.Comercial_KPIs_Diarios_v2 (
            ...
            {kpi.tickets_total}, {kpi.pax_total}, {kpi.ticket_promedio}, {kpi.ticket_promedio},
