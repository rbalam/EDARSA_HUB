...
def _mapear_codigo_a_unidad_negocio_pk(codigo_empresa: str) -> str:
    ...
    - Los datos en vw_Comercial_KPIs_Diarios_v2_Runtime deben usar códigos canónicos
...
def _query_edarsahub_tablero(query: str) -> List[Dict]:
    ...
    Fuente: vw_Comercial_KPIs_Diarios_v2_Runtime y Comercial_Ventas_Dia_Abiertas_v2.
...
def _get_ultimo_dia_con_datos_edarsahub(server_id: str, mes: int, anio: int) -> Optional[int]:
    """
    Obtiene el último día con ventas registradas en vw_Comercial_KPIs_Diarios_v2_Runtime.
...
def _get_kpis_periodo_edarsahub(
    ...
    """
    Obtiene KPIs agregados de vw_Comercial_KPIs_Diarios_v2_Runtime para un período.
    ...
    RAZÓN: Para MPRO, los datos en vw_Comercial_KPIs_Diarios_v2_Runtime tienen un server_id
...
def _obtener_kpis_tablero_desde_edarsahub(
    ...
    - NO consulta MongoDB
    - Lee de vw_Comercial_KPIs_Diarios_v2_Runtime
    ...
    return {
        ...
        "fuente": "EDARSAHUB",
        "_meta": {
            "tabla": "vw_Comercial_KPIs_Diarios_v2_Runtime",
...
def get_kpis_softrestaurant(server, fecha_ini, fecha_fin, fecha_ini_ant, fecha_fin_ant, fecha_ini_año_ant, fecha_fin_año_ant, dias_transcurridos, dias_mes, solo_ventas_dia=False):
    ...
    - Lee EXCLUSIVAMENTE de EDARSAHUB (vw_Comercial_KPIs_Diarios_v2_Runtime)
    ...
    # usados en vw_Comercial_KPIs_Diarios_v2_Runtime
    # =========================================================================
    ...
    # ============================================================================
    # MODO KPIs HISTÓRICOS/ACUMULADOS: Leer de vw_Comercial_KPIs_Diarios_v2_Runtime
    # ============================================================================
...
def get_kpis_mpro_por_sucursal(server, fecha_ini, fecha_fin, fecha_ini_ant, fecha_fin_ant, fecha_ini_año_ant, fecha_fin_año_ant, dias_transcurridos, dias_mes, solo_ventas_dia=False):
    ...
    # - Usar la misma fuente que SoftRestaurant: vw_Comercial_KPIs_Diarios_v2_Runtime
    # 
    ...
    for suc in sucursales_mpro:
        ...
        # Mapear código a unidad_negocio_pk usado en vw_Comercial_KPIs_Diarios_v2_Runtime
...
# EDARSAHUB SÍ tiene datos en vw_Comercial_KPIs_Diarios_v2_Runtime.
# 
...
#
# SOLUCIÓN: Usar la MISMA fuente que Tablero Ejecutivo (vw_Comercial_KPIs_Diarios_v2_Runtime)
...
def get_last_valid_snapshot_edarsahub(server_id: str) -> Dict:
    ...
    Busca en vw_Comercial_KPIs_Diarios_v2_Runtime el registro más reciente para el servidor,
    ...
    try:
        conn = get_edarsahub_pymssql_connection(timeout=10, login_timeout=10)  # noqa: F821
