...
def listar_competidores(
    ...
    if unidad_negocio_pk:
        where_clauses.append(f"c.UnidadNegocioID = {unidad_negocio_pk}")
    if solo_activos:
...
def obtener_estadisticas_competidores(unidad_negocio_pk: int) -> Dict[str, Any]:
    """
...
def obtener_estadisticas_menu_items(unidad_negocio_pk: int) -> Dict[str, Any]:
    """
