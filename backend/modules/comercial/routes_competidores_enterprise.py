...
- /api/comercial/competidores: Consultas por unidad (OBLIGATORIO unidad_negocio_pk)

REGLAS:
- TODAS las consultas de competidores DEBEN incluir unidad_negocio_pk
...
# =============================================================================
# CONSULTAS POR UNIDAD (PRINCIPAL - OBLIGATORIO unidad_negocio_pk)
# =============================================================================

@router.get("/competidores", summary="Listar competidores por unidad (OBLIGATORIO)")
async def listar_competidores_unidad_endpoint(
    unidad_negocio_pk: int = Query(..., description="ID de unidad de negocio (OBLIGATORIO)"),
    ...
    REGLA CRÍTICA: unidad_negocio_pk es OBLIGATORIO.
...
async def obtener_competidor_unidad_endpoint(
    ...
    if not result:
        raise HTTPException(
            status_code=404, 
            detail=f"Competidor no encontrado en unidad {unidad_negocio_pk}"
        )
