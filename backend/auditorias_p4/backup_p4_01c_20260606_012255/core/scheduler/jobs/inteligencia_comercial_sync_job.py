...
UNIDADES_CONFIG = {
    ...
    "130QRO": {
        ...
        "port": 1433,
        "database": "QUERETARO",
        "username": os.environ.get("130QRO_DB_USER", "<REDACTED_EDARSAHUB_SQL_USER>"),
        "password": os.environ.get("130QRO_DB_PASS", "<REDACTED_EDARSAHUB_SQL_PASSWORD>"),
    },
    "ORIGEN": {
        "system_type": "MPRO",
        "host": "<REDACTED_EDARSAHUB_SQL_HOST>",
        "port": 1433,
        "database": "ORIGEN",
        "username": os.environ.get("ORIGEN_DB_USER", "<REDACTED_EDARSAHUB_SQL_USER>"),
        "password": os.environ.get("ORIGEN_DB_PASS", "<REDACTED_EDARSAHUB_SQL_PASSWORD>"),
    },
}
