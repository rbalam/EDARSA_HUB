...
class RepositoryCuadresZEdarsahub:
    ...
    def listar_cuadres_z(self, filtros: Dict = None) -> List[Dict]:
        ...
        Filtros soportados:
        - unidad_negocio_pk / unidades_permitidas (lista)
        - fecha_inicio
        - fecha_fin
        - estatus_cuadre
        - estatus_tesoreria
        ...
        try:
            ...
            elif 'unidad_negocio_pk' in filtros:
                where_clauses.append('cz.UnidadNegocioID = %s')
                params.append(filtros['unidad_negocio_pk'])
    ...
    def resolver_server_id_a_unidad(self, server_id: str) -> Optional[Dict]:
        ...
        Returns:
            Dict con unidad_negocio_pk, nombre, empresa_id si se encuentra
        ...
        try:
            ...
            # (en algunos casos server_id = unidad_negocio_pk)
            cursor.execute('''
    ...
    def listar_cuadres_z_por_server_id(self, server_id: str, filtros: Dict = None) -> List[Dict]:
        ...
        que envía server_id en lugar de unidad_negocio_pk.
