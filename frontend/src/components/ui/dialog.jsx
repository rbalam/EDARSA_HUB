...
const DialogContent = React.forwardRef(({ className, children, draggable = false, hideCloseButton = false, overlayClassName, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Usar posicionamiento diferente según si es draggable o no
        draggable 
          ? "left-[50%] top-[50%]" // Sin translate base, se maneja con style
