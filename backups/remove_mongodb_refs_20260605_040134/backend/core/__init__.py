...
# - connection_resolver.py: Resolver centralizado de conexiones (NUEVO)
# - providers.py: Providers por tipo de sistema (NUEVO)
...
#
# ARQUITECTURA DE CONEXIONES (2026-04-19):
# - ConnectionResolver: Resolver central - TODOS los módulos deben usarlo
# - Providers: sql_classic, mpro_sql, local_api
...
# Connection Resolver Central (2026-04-19)
...
# Providers por sistema
from core.providers import (
    ProviderResult,
    SQLClassicProvider,
    MPROSQLProvider,
    LocalAPIProvider,
    get_sql_classic_provider,
    get_mpro_sql_provider,
    get_local_api_provider
)
