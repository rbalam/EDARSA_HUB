...
TEST_EMAIL = os.environ.get("TEST_ADMIN_EMAIL", TEST_ADMIN_EMAIL)
TEST_PASSWORD = os.environ.get("TEST_ADMIN_PASSWORD", TEST_ADMIN_PASSWORD)
...
class TestDashboardMPRO:
    ...
    def test_dashboard_mpro_loads(self, auth_headers):
        ...
        assert data["success"], f"MPRO dashboard returned error: {data.get('message')}"
...
class TestDashboardCienfuegos:
    ...
    def test_dashboard_cienfuegos_loads(self, auth_headers):
        ...
        assert data.get("success"), f"Cienfuegos dashboard error: {data.get('message')}"
...
class TestDashboardLaEstelar:
    ...
    def test_dashboard_la_estelar_loads(self, auth_headers):
        ...
        assert data.get("success"), f"LA ESTELAR dashboard error: {data.get('message')}"
