...
class RepositoryCortesCajaEdarsahub:
    ...
    def listar_cortes_caja(
        ...
        Args:
            filtros: Dict con:
                - unidad_negocio_id: UUID de la unidad
                - server_id: UUID del servidor (alias de unidad_negocio_id)
        ...
        try:
            ...
            # Filtro por unidad de negocio (server_id o unidad_negocio_id)
            server_id = filtros.get('server_id') or filtros.get('unidad_negocio_id')
            if server_id:
