...
from .routes.automatizacion_compras_routes import router as automatizacion_compras_router
...
router_fase2_operativo.include_router(
    automatizacion_compras_router,
    tags=["Fase2-Automatizaciones-Operativas"]
)
