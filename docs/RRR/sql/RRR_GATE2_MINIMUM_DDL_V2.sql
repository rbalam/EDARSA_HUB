/*
RRR GATE 2 - MINIMUM DDL V2 - DESIGN ONLY
NO EJECUTAR DESDE ESTE JOB. Production=false.
Correcciones certificadas por RRR-GATE2B-FK-TYPE-PREFLIGHT-READONLY-V1-20260908:
...
- Unidad/sucursal: PENDIENTE de preflight dedicado; no se fija columna/FK en V2.
*/
...
CREATE TABLE dbo.RRR_Eventos (
    ...
    /* Unidad/sucursal se incorpora solo despues del preflight dedicado y una version posterior del DDL. */
);
...
/* Vistas propuestas para gate posterior:
