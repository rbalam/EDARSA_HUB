...
- [ ] Eliminar 28 colecciones Mongo restantes (pendiente script usuario)
  ...
  - [x] (2026-06-07) COMPARATIVO SQL↔Mongo (Fase 3 NO destructivo): 107 colecciones × 478 tablas EDARSAHUB. Matriz de cobertura + clasificación + recomendación por colección. Reportes MD/JSON/CSV en `/app/docs/reports/mongo_sql_compare_20260607_182308/`. Resumen recomendaciones: BASE_DE_PRUEBAS_CANDIDATA_A_BORRADO=53, CANDIDATA_A_BORRADO_POSTERIOR=20, MIGRAR_ANTES_DE_BORRAR=25, VALIDAR_MANUALMENTE=9. Script del usuario AUDITADO y RECHAZADO (usaba pyodbc roto -libodbc.so.2 ausente- y no cargaba .env); reimplementado con pymssql/execute_sql_query + dotenv. NADA borrado. Sigue pendiente decisión de borrado quirúrgico.
